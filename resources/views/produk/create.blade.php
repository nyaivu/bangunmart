    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form action="{{ route('produk.store') }}" method="POST" class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-md-6 mb-3">
                <label class="block text-sm font-semibold mb-1">Supplier Utama</label>
                <select name="id_supplier" class="w-full px-4 py-2 border border-slate-300 rounded-xl" required>
            ...
            <div class="col-md-6 mb-3">
                <label class="block text-sm font-semibold mb-1">Harga Beli Awal</label>
                <input class="w-full px-4 py-2 border border-slate-300 rounded-xl" type="number" name="harga_beli" class="form-control" placeholder="Rp.">
            </div>
