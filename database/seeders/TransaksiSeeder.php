...
class TransaksiSeeder extends Seeder {
    public function run(): void {
        ...
        $id1 = DB::table('penjualan')->insertGetId([
            'id_pegawai' => 1, 'id_pelanggan' => 1, 'status_nota' => 'dibayar', 'tgl_nota' => '2023-12-01 10:00:00'
        ]);
        ...
        $id2 = DB::table('penjualan')->insertGetId([
            'id_pegawai' => 2, 'id_pelanggan' => 2, 'status_nota' => 'dibayar', 'tgl_nota' => '2023-12-01 11:30:00'
        ]);
        DB::table('detail_penjualan')->insert([
        ...
        $id3 = DB::table('penjualan')->insertGetId([
            'id_pegawai' => 1, 'id_pelanggan' => 3, 'status_nota' => 'dibayar', 'tgl_nota' => '2023-12-02 09:15:00'
        ]);
        DB::table('detail_penjualan')->insert([
